...
export default function HireMe() {
  ...
  return (
    ...
    >
      ...
      <p
        className={`flex justify-center items-center md:w-24 md:h-24 ${
          isDarkMode
            ? "bg-white text-dark  shadow-dark"
            : "bg-dark text-white  shadow-white"
        } text-center rounded-[50%] absolute bottom-[4.051rem] left-[6.45rem] font-extrabold`}
      >
        Contate-me
      </p>
    </Link>
