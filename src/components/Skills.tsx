          ...
          return (
            <div
              ...
              className={`w-32 h-20 rounded-full ${
                isDarkMode
                  ? "bg-white hover:bg-dark  text-dark hover:text-light "
                  : "bg-dark hover:bg-light  text-light hover:text-dark"
              }    hover:border-2 flex justify-center items-center absolute`}
